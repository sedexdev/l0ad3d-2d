...
GMapAreaDefinitions = {
    --========== JOINING AREAS ==========
    [1] = {x = nil, y = nil, width = 5, height = 2, type = 'corridor', direction = 'horizontal', bends = nil, doors = nil, joins = {{17, 'L'}, {18, 'R'}}},
    [2] = {x = nil, y = nil, width = 10, height = 2, type = 'corridor', direction = 'horizontal', bends = nil, doors = nil, joins = {{18, 'L'}, {24, 'R'}}},
    [3] = {x = nil, y = nil, width = 1, height = 5, type = 'corridor', direction = 'vertical', bends = nil, doors = nil, joins = {{18, 'T'}, {22, 'B'}}},
    [4] = {x = nil, y = nil, width = 1, height = 8, type = 'corridor', direction = 'vertical', bends = nil, doors = nil, joins = {{24, 'B'}, {27, 'T'}}},
    [5] = {x = nil, y = nil, width = 1, height = 5, type = 'corridor', direction = 'vertical', bends = nil, doors = nil, joins = {{18, 'B'}, {23, 'T'}}},
    [6] = {x = nil, y = nil, width = 1, height = 12, type = 'corridor', direction = 'vertical', bends = nil, doors = {R = 'purple'}, joins = {{17, 'B'}, {19, 'T'}}},
    [7] = {x = nil, y = nil, width = 5, height = 2, type = 'corridor', direction = 'horizontal', bends = nil, doors = nil, joins = {{20, 'L'}, {6, 'R'}}},
    [8] = {x = nil, y = nil, width = 5, height = 2, type = 'corridor', direction = 'horizontal', bends = nil, doors = nil, joins = {{17, 'R'}, {21, 'L'}}},
    [9] = {x = nil, y = nil, width = 1, height = 5, type = 'corridor', direction = 'vertical', bends = nil, doors = nil, joins = {{21, 'T'}, {30, 'B'}}},
    [10] = {x = nil, y = nil, width = 16, height = 2, type = 'corridor', direction = 'horizontal', bends = {'RT'}, doors = {B = 'purple'}, joins = {{21, 'R'}, {11, 'B'}}},
    [11] = {x = nil, y = nil, width = 1, height = 5, type = 'corridor', direction = 'vertical', bends = nil, doors = nil, joins = {{31, 'T'}, {10, 'B'}}},
