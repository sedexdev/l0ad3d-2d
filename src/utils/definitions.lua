...
GMapAreaDefinitions = {
    ...
    [24] = {x = -15680, y = -1280, width = 8, height = 16, type = 'area', adjacentAreas = {[1] = {areaID = 25, doorID = 3}, [2] = {areaID = 26, doorID = 3}}, doors = {B = 'purple', R = 'purple'}},
    [25] = {x = -17680, y = -1120, width = 6, height = 6, type = 'area', adjacentAreas = nil, doors = {R = 'purple'}},
    [26] = {x = -18320, y = 160, width = 8, height = 8, type = 'area', adjacentAreas = nil, doors = {R = 'blue'}},
    [27] = {x = -18560, y = 2560, width = 26, height = 22, type = 'area', adjacentAreas = {[1] = {areaID = 28, doorID = 2}, [2] = {areaID = 29, doorID = 2}}, doors = {T = 'red'}},
    [28] = {x = -18240, y = 6160, width = 8, height = 8, type = 'area', adjacentAreas = nil, doors = {T = 'purple'}},
    [29] = {x = -14400, y = 6160, width = 8, height = 8, type = 'area', adjacentAreas = nil, doors = {T = 'purple'}},
    [30] = {x = 5440, y = -2080, width = 4, height = 4, type = 'area', adjacentAreas = nil, doors = {B = 'purple'}},
    [31] = {x = 6720, y = 1040, width = 20, height = 22, type = 'area', adjacentAreas = {[1] = {areaID = 32, doorID = 1}}, doors = {B = 'purple', T = 'purple'}},
    [32] = {x = 13200, y = 2080, width = 6, height = 8, type = 'area', adjacentAreas = nil, doors = {L = 'purple'}},
    [33] = {x = 9680, y = -2560, width = 16, height = 12, type = 'area', adjacentAreas = nil, doors = {B = 'purple', R = 'purple'}},
    [34] = {x = 13520, y = 4720, width = 20, height = 20, type = 'area', adjacentAreas = {[1] = {areaID = 35, doorID = 2}}, doors = {L = 'purple'}},
    [35] = {x = 15360, y = 8000, width = 8, height = 8, type = 'area', adjacentAreas = nil, doors = {T = 'purple'}},
    [36] = {x = 16480, y = -160, width = 24, height = 24, type = 'area', adjacentAreas = {[1] = {areaID = 37, doorID = 2}}, doors = {T = 'green'}},
    [37] = {x = 21280, y = 3760, width = 8, height = 8, type = 'area', adjacentAreas = nil, doors = {T = 'purple'}}
}
